...
namespace NanolekPrototype.Context.Migrations
{
    ...
    [Migration("20210831123120_first migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NanolekPrototype.Domain.Models.PackagingProtocol", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NanolekPrototype.Domain.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NanolekPrototype.Domain.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NanolekPrototype.Domain.Models.PackagingProtocol", b =>
                {
                    b.HasOne("NanolekPrototype.Domain.Models.User", "ResponsibleUserOOK")
                        .WithMany()
                        .HasForeignKey("ResponsibleUserOOKId");

                    b.HasOne("NanolekPrototype.Domain.Models.User", "ResponsibleUserTLF")
                        .WithMany()
