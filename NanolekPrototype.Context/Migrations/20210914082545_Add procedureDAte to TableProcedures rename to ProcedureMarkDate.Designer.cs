...
namespace NanolekPrototype.Context.Migrations
{
    ...
    [Migration("20210914082545_Add procedureDAte to TableProcedures rename to ProcedureMarkDate")]
    partial class AddprocedureDAtetoTableProceduresrenametoProcedureMarkDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NanolekPrototype.EntityModels.Models.FormAssignmentForMarkingThermalTransferLabelOnCorrugatedBox", b =>
                {
                    ...
                    b.ToTable("FormAssignmentForMarkingThermalTransferLabelOnCorrugatedBox");
                });
            ...
            modelBuilder.Entity("NanolekPrototype.EntityModels.Models.TableProcedure", b =>
                {
                    ...
                    b.Property<DateTime?>("ProcedureMarkDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("NanolekPrototype.EntityModels.Models.FormAssignmentForMarkingThermalTransferLabelOnCorrugatedBox", b =>
                {
                    b.HasOne("NanolekPrototype.EntityModels.Models.PackagingProtocol", "PackagingProtocol")
                        .WithMany("FormAssignmentForMarkingThermalTransferLabelOnCorrugatedBoxes")
                        .HasForeignKey("PackagingProtocolId");

                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "TaskGiven")
                        .WithMany("FormAssignmentForMarkingThermalTransferLabelOnCorrugatedBoxTaskGivens")
                        .HasForeignKey("TaskGivenId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "TaskGot")
                        .WithMany("FormAssignmentForMarkingThermalTransferLabelOnCorrugatedBoxTaskGots")
            ...
            modelBuilder.Entity("NanolekPrototype.EntityModels.Models.FormMaterialBalanceOfGPByLot", b =>
                {
                    ...
                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "ShiftMaster")
                        .WithMany("FormMaterialBalanceOfGPByLotShiftMasters")
                        .HasForeignKey("ShiftMasterId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "TaskMaster")
                        .WithMany("FormMaterialBalanceOfGPByLotTaskMasters")
            ...
            modelBuilder.Entity("NanolekPrototype.EntityModels.Models.FormReceptionAndMovementOfBulkProduct", b =>
                {
                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "CalcedByUser")
                        .WithMany("FormReceptionAndMovementOfBulkProductCalcers")
                        .HasForeignKey("CalcedByUserId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "CheckedByUser")
                        .WithMany("FormReceptionAndMovementOfBulkProductCheckers")
                        .HasForeignKey("CheckedByUserId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "ShiftMaster")
                        .WithMany("FormReceptionAndMovementOfBulkProductShiftMasters")
                        .HasForeignKey("ShiftMasterId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("NanolekPrototype.EntityModels.Models.FormReceptionAndMovementOfPackingMaterial", b =>
                {
                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "CalcedByUser")
                        .WithMany("FormReceptionAndMovementOfPackingMaterialCalcers")
                        .HasForeignKey("CalcedByUserId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "CheckedByUser")
                        .WithMany("FormReceptionAndMovementOfPackingMaterialCheckers")
                        .HasForeignKey("CheckedByUserId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "ShiftMaster")
                        .WithMany("FormReceptionAndMovementOfPackingMaterialShiftMasters")
                        .HasForeignKey("ShiftMasterId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("NanolekPrototype.EntityModels.Models.FormSamplingFinishedProduct", b =>
                {
                    ...
                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "ShiftMaster")
                        .WithMany("FormSamplingFinishedProductShiftMasters")
                        .HasForeignKey("ShiftMasterId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "TaskMaster")
                        .WithMany("FormSamplingFinishedProductTaskMasters")
                        .HasForeignKey("TaskMasterId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("NanolekPrototype.EntityModels.Models.TableCheckingProcedure", b =>
                {
                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "Executor")
                        .WithMany("TableCheckingProcedureExecutors")
            ...
            modelBuilder.Entity("NanolekPrototype.EntityModels.Models.TablePackagingControl", b =>
                {
                    ...
                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "TaskMaster")
                        .WithMany("TablePackagingControlTaskMasters")
                        .HasForeignKey("TaskMasterId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("NanolekPrototype.EntityModels.Models.TableProcedure", b =>
                {
                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "Checker")
                        .WithMany("TableProcedureCheckers")
                        .HasForeignKey("CheckerId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "Executor")
                        .WithMany("TableProcedureExecutors")
                        .HasForeignKey("ExecutorId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("NanolekPrototype.EntityModels.Models.TableReceptionOfMaterial", b =>
                {
                    ...
                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "ShiftMaster")
                        .WithMany("TableReceptionOfMaterialShiftMasters")
                        .HasForeignKey("ShiftMasterId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("NanolekPrototype.EntityModels.Models.TableSampleSelection", b =>
                {
                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "EmployeeOKK")
                        .WithMany("TableSampleSelectionEmployeeOKKs")
            ...
            modelBuilder.Entity("NanolekPrototype.EntityModels.Models.TableSettingUpTechnologicalEquipment", b =>
                {
                    ...
                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "ServiceTechnician")
                        .WithMany("TableSettingUpTechnologicalEquipmentServiceTechnicians")
            ...
            modelBuilder.Entity("NanolekPrototype.EntityModels.Models.TableVerificationAction", b =>
                {
                    ...
                    b.HasOne("NanolekPrototype.EntityModels.Models.User", "TaskMaster")
                        .WithMany("TableVerificationActionTaskMasters")
                        .HasForeignKey("TaskMasterId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("NanolekPrototype.EntityModels.Models.PackagingProtocol", b =>
                {
                    b.Navigation("FormAssignmentForMarkingThermalTransferLabelOnCorrugatedBoxes");
            ...
            modelBuilder.Entity("NanolekPrototype.EntityModels.Models.User", b =>
                {
                    b.Navigation("FormAssignmentForMarkingThermalTransferLabelOnCorrugatedBoxTaskGivens");

                    b.Navigation("FormAssignmentForMarkingThermalTransferLabelOnCorrugatedBoxTaskGots");

                    b.Navigation("FormMaterialBalanceOfGPByLotCalcedByUsers");

                    b.Navigation("FormMaterialBalanceOfGPByLotCheckedByUsers");

                    b.Navigation("FormMaterialBalanceOfGPByLotCheckedPUByUsers");

                    b.Navigation("FormMaterialBalanceOfGPByLotShiftMasters");

                    b.Navigation("FormMaterialBalanceOfGPByLotTaskMasters");

                    b.Navigation("FormReceptionAndMovementOfBulkProductCalcers");

                    b.Navigation("FormReceptionAndMovementOfBulkProductCheckers");

                    b.Navigation("FormReceptionAndMovementOfBulkProductShiftMasters");

                    b.Navigation("FormReceptionAndMovementOfPackingMaterialCalcers");

                    b.Navigation("FormReceptionAndMovementOfPackingMaterialCheckers");

                    b.Navigation("FormReceptionAndMovementOfPackingMaterialShiftMasters");

                    b.Navigation("FormSamplingFinishedProductShiftMasters");

                    b.Navigation("FormSamplingFinishedProductTaskMasters");

                    b.Navigation("OOK");

                    b.Navigation("TableCheckingProcedureExecutors");

                    b.Navigation("TablePackagingControlTaskMasters");

                    b.Navigation("TableProcedureCheckers");

                    b.Navigation("TableProcedureExecutors");

                    b.Navigation("TableReceptionOfMaterialShiftMasters");

                    b.Navigation("TableSampleSelectionEmployeeOKKs");

                    b.Navigation("TableSettingUpTechnologicalEquipmentServiceTechnicians");

                    b.Navigation("TableVerificationActionTaskMasters");
