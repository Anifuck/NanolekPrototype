...
namespace NanolekPrototype.Controllers
{
    public class FormReceptionAndMovementOfBulkProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IsActive,InternalCodeOfMaterial,Specification,CalcedByUserDate,CheckedByUserDate,Date,GetPRP,PartSAP,IsCorrespondToControlIndicators,IsCorrespondToShelfLife,EntredIntoGPPackages,EntredIntoGPUnits,GarbageUnits,DefectFirstPackageUnits,SampleSelectionUnits,GarbageSecondPackageUnits")] FormReceptionAndMovementOfBulkProduct formReceptionAndMovementOfBulkProduct)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IsActive,InternalCodeOfMaterial,Specification,CalcedByUserDate,CheckedByUserDate,Date,GetPRP,PartSAP,IsCorrespondToControlIndicators,IsCorrespondToShelfLife,EntredIntoGPPackages,EntredIntoGPUnits,GarbageUnits,DefectFirstPackageUnits,SampleSelectionUnits,GarbageSecondPackageUnits")] FormReceptionAndMovementOfBulkProduct formReceptionAndMovementOfBulkProduct)
        {
