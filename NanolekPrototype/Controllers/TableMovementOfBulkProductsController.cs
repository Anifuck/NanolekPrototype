...
namespace NanolekPrototype.Controllers
{
    public class TableMovementOfBulkProductsController : Controller
    {
        ...
        {
            var applicationContext = _context.MovementOfBulkProducts.Include(t => t.FormReceptionAndMovementOfBulkProduct);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var tableMovementOfBulkProduct = await _context.MovementOfBulkProducts
                .Include(t => t.FormReceptionAndMovementOfBulkProduct)
        ...
        {
            ViewData["FormReceptionAndMovementOfBulkProductId"] = new SelectList(_context.FormReceptionAndMovementOfBulkProducts, "Id", "Discriminator");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FormReceptionAndMovementOfBulkProductId,IsActive,GarbageKg")] TableMovementOfBulkProduct tableMovementOfBulkProduct)
        {
            ...
            ViewData["FormReceptionAndMovementOfBulkProductId"] = new SelectList(_context.FormReceptionAndMovementOfBulkProducts, "Id", "Discriminator", tableMovementOfBulkProduct.FormReceptionAndMovementOfBulkProductId);
            return View(tableMovementOfBulkProduct);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FormReceptionAndMovementOfBulkProductId,IsActive,GarbageKg")] TableMovementOfBulkProduct tableMovementOfBulkProduct)
        {
